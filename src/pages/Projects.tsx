...
import { Plus, Search, Calendar, Users, Filter, UserPlus, TrendingUp, AlertTriangle, CheckCircle, X } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
              {filteredProjects.map((project) => {
                ...
                return (
                  <Card key={project._id} className="group hover:shadow-xl transition-all duration-300 cursor-pointer border-0 shadow-sm bg-white hover:-translate-y-1">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500 mt-1">
                          {tasks.filter(t => t.project?._id === project._id && t.status === 'done').length} of{' '}
                          {tasks.filter(t => t.project?._id === project._id).length} tasks completed
                        </div>
                      </div>
