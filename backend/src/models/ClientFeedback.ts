...
import { IClientFeedback } from '../types/index.js';

const clientFeedbackSchema = new mongoose.Schema<IClientFeedback>({
  project: {
...
export const ClientFeedback = mongoose.model<IClientFeedback>('ClientFeedback', clientFeedbackSchema);
