...
import { CreateConfluencePageRequest, UpdateConfluencePageRequest } from '../types/index.js';

export const createConfluencePage = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
    const {
      title,
      content,
      ...
      editPermissions,
      parentPageId
    }: CreateConfluencePageRequest = req.body;
...
export const getConfluencePage = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
export const updateConfluencePage = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
    const { pageId } = req.params;
    const updateData: UpdateConfluencePageRequest = req.body;
    const userRole = req.user!.role;
    ...
    const updatedPage = await ConfluencePage.findByIdAndUpdate(
      pageId,
      finalUpdateData,
...
export const deleteConfluencePage = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
    const { pageId } = req.params;
    const userRole = req.user!.role;
...
export const getPageVersions = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
    const { pageId } = req.params;
