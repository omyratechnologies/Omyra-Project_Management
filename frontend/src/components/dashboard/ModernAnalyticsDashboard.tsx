  ...
  const performanceMetrics = [
    {
      ...
      color: "text-blue-600",
      bgColor: "bg-blue-50",
      trend: analytics.overview.teamProductivity.trend
    },
    {
      title: "Team Productivity",
      value: analytics.overview.teamProductivity.thisWeek,
      max: 100,
    ...
    },
    {
      ...
      value: analytics.personal.productivity.thisWeek,
      max: 100,
      icon: <Activity className="w-5 h-5" />,
      color: "text-amber-600",
      bgColor: "bg-amber-50",
      trend: analytics.personal.productivity.trend
    }
  ];
            ...
            <Card className="border-0 shadow-sm">
              ...
              <CardContent>
                <div className="space-y-4">
                  {analytics.team.mostActive.map((member, index) => (
                  ...
                  {analytics.team.mostActive.length === 0 && (
                  ...
                  {analytics.projects.upcomingDeadlines.map((project) => (
                    <div key={project.id} className="p-4 border border-gray-200 rounded-lg hover:shadow-sm transition-shadow">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <Badge 
                          variant={project.daysUntilDue <= 3 ? "destructive" : project.daysUntilDue <= 7 ? "default" : "outline"}
                          className="text-xs"
                        >
                          {project.daysUntilDue}d left
                        </Badge>
                      </div>
