...
export const NotificationCenter = () => {
  ...
  if (isLoading) {
    return (
      <Card data-tour="notifications" className="border-0 shadow-sm bg-gradient-to-br from-white to-gray-50/50">
  ...
  return (
    <Card data-tour="notifications" className="border-0 shadow-sm bg-gradient-to-br from-white to-gray-50/50 hover:shadow-md transition-shadow duration-300">
      <CardHeader className="pb-4">
